 ...
 */
final class Version20200501134930 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pokemon AS SELECT id, id_pokemon, name, difficulty, description FROM pokemon');
        $this->addSql('DROP TABLE pokemon');
        $this->addSql('CREATE TABLE pokemon (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_pokemon INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, difficulty INTEGER DEFAULT 1 NOT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO pokemon (id, id_pokemon, name, difficulty, description) SELECT id, id_pokemon, name, difficulty, description FROM __temp__pokemon');
        ...
        $this->addSql('DROP INDEX IDX_9D40DE1BF7BFE87C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__topic AS SELECT id, author_id, category_id, sub_category_id, title, content, created_at, featured, is_active FROM topic');
        $this->addSql('DROP TABLE topic');
        $this->addSql('CREATE TABLE topic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, sub_category_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, featured BOOLEAN DEFAULT \'0\', is_active BOOLEAN DEFAULT \'1\' NOT NULL, CONSTRAINT FK_9D40DE1BF675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9D40DE1B12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9D40DE1BF7BFE87C FOREIGN KEY (sub_category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO topic (id, author_id, category_id, sub_category_id, title, content, created_at, featured, is_active) SELECT id, author_id, category_id, sub_category_id, title, content, created_at, featured, is_active FROM __temp__topic');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pokemon AS SELECT id, id_pokemon, name, difficulty, description FROM pokemon');
        $this->addSql('DROP TABLE pokemon');
        $this->addSql('CREATE TABLE pokemon (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_pokemon INTEGER NOT NULL, name VARCHAR(255) NOT NULL, difficulty INTEGER DEFAULT 1 NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO pokemon (id, id_pokemon, name, difficulty, description) SELECT id, id_pokemon, name, difficulty, description FROM __temp__pokemon');
        $this->addSql('DROP TABLE __temp__pokemon');
        $this->addSql('DROP INDEX IDX_9D40DE1BF675F31B');
        $this->addSql('DROP INDEX IDX_9D40DE1B12469DE2');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__topic AS SELECT id, author_id, category_id, sub_category_id, title, content, created_at, featured, is_active FROM topic');
        $this->addSql('DROP TABLE topic');
        $this->addSql('CREATE TABLE topic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, sub_category_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, content CLOB NOT NULL, created_at DATETIME NOT NULL, featured BOOLEAN DEFAULT \'0\', is_active BOOLEAN DEFAULT \'1\' NOT NULL)');
        $this->addSql('INSERT INTO topic (id, author_id, category_id, sub_category_id, title, content, created_at, featured, is_active) SELECT id, author_id, category_id, sub_category_id, title, content, created_at, featured, is_active FROM __temp__topic');
        $this->addSql('DROP TABLE __temp__topic');
        $this->addSql('CREATE INDEX IDX_9D40DE1BF675F31B ON topic (author_id)');
        $this->addSql('CREATE INDEX IDX_9D40DE1B12469DE2 ON topic (category_id)');
