 ...
 */
final class Version20200321143546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE topic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, subcategory_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, content CLOB NOT NULL, created_at DATETIME NOT NULL, featured BOOLEAN DEFAULT NULL, active BOOLEAN NOT NULL)');
        ...
        , password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, gender BOOLEAN DEFAULT NULL, birthday DATE DEFAULT NULL, created_at DATETIME NOT NULL, active BOOLEAN NOT NULL, avatar VARCHAR(255) DEFAULT NULL)');
