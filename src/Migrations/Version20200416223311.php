 ...
 */
final class Version20200416223311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD COLUMN description VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_6336F6A7A76ED395 ON pokedex (user_id)');
        $this->addSql('CREATE INDEX IDX_6336F6A72FE71C3E ON pokedex (pokemon_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pokemon AS SELECT id, id_pokemon, name, difficulty FROM pokemon');
        $this->addSql('DROP TABLE pokemon');
        $this->addSql('CREATE TABLE pokemon (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_pokemon INTEGER NOT NULL, name VARCHAR(255) NOT NULL, difficulty INTEGER DEFAULT 1 NOT NULL)');
        $this->addSql('INSERT INTO pokemon (id, id_pokemon, name, difficulty) SELECT id, id_pokemon, name, difficulty FROM __temp__pokemon');
