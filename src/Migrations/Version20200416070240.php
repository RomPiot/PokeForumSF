 ...
 */
final class Version20200416070240 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN pokeball INTEGER DEFAULT 3');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, roles, password, name, lastname, email, birthday, created_at, avatar, is_active, is_blocked, gender, description FROM user');
        ...
        , password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, birthday DATE DEFAULT NULL, created_at DATETIME NOT NULL, avatar VARCHAR(255) DEFAULT NULL, is_active BOOLEAN DEFAULT \'1\' NOT NULL, is_blocked BOOLEAN DEFAULT \'0\' NOT NULL, gender VARCHAR(255) DEFAULT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, roles, password, name, lastname, email, birthday, created_at, avatar, is_active, is_blocked, gender, description) SELECT id, username, roles, password, name, lastname, email, birthday, created_at, avatar, is_active, is_blocked, gender, description FROM __temp__user');
