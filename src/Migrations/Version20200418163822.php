 ...
 */
final class Version20200418163822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE badge ADD COLUMN level INTEGER DEFAULT 1 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__badge AS SELECT id, name, image FROM badge');
        ...
        $this->addSql('INSERT INTO badge (id, name, image) SELECT id, name, image FROM __temp__badge');
